    ...
    class RestrictionTypes extends Enum {
        ...
        public function getFormGroupRender() {
            ...
            $html = "<div class=\"form-group\">"
                  ...
                  .                 "<input type=\"number\" name=\"".$small_name."_1\" class=\"form-control\" placeholder=\"".$pretty_name." (px)\" aria-describedby=\"".$small_name."_1_desc\"/>"
                  .             "</div>"
                  .             "<div class=\"col-4\">"
                  .                 "<input type=\"number\" name=\"".$small_name."_chance_1\" min=\"1\" max=\"100\" class=\"form-control percentage_input\" placeholder=\"Likelihood\"/>"
                  .             "</div>"
                  .         "</div>"
                  .     "</div>"
                  . "</div>";
